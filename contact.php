...
if(isset($_POST['btn'])){
    ...
    if(empty($_POST['name']) || empty($_POST['email']) || empty($_POST['subject']) || empty($_POST['msg'])){
        echo"<script>alert('Fill the values');</script>";
    }
    else{
    $name = $_POST['name'];
    $email = $_POST['email'];
    ...
    <nav style="  background-image: linear-gradient(to bottom right,  rgb(72, 164, 189) , rgb(130, 130, 175));"
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a style="font-weight: bolder;color: rgb(0, 242, 255);" href="contact.html" class="nav-item nav-link active">Contact</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m26!1m12!1m3!1d7238.042185890361!2d67.18658522512548!3d24.897262136146207!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m11!3e6!4m3!3m2!1d24.8933191!2d67.18851169999999!4m5!1s0x3eb3378adcaf5a1d%3A0xeca5590b9962218!2scogito%20the%20computer%20institute!3m2!1d24.9014575!2d67.19313869999999!5e0!3m2!1sen!2s!4v1684586233210!5m2!1sen!2s"
                        width="400" height="350" style="border:0;" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s" style="margin-left:71%; margin-top:-33%;">
